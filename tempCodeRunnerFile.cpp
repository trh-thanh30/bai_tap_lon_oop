...
void ChefStaffMenu(Warehouse_Staff warehouses[], Chef_Staff chefs[], int totalChefs, int &numberProductReq)
{
    int choice;
...
void WarehouseStaffMenu(Warehouse_Staff warehouses[], int &numberProductReq)
{
    int choice;
    do
    {
        ...
        cout << "2. Send request to inventory " << endl;
        cout << "3. Show requests" << endl;
